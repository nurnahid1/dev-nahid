  ...
  const sendEmail = (e) => {
    ...
    return (
        <div >
            ...
            <h1 className='text-white text-2xl md:text-3xl lg"text-4xl text-center  border-indigo-700 font-roboto pl-2 text-gradient'>Contact with me</h1>
                    </div>
            <img className='max-w-xs md:max-w-xs lg:max-w-md pb-5 pt-3 mx-auto px-3 md:px-0' src={contact} alt="contact" />
            </div>

            <div className=' p-5  mb-20 md:mb-2'>
                <div className='rounded-lg shadow-md p-3 mb-3 bg-[#3f37c9] hover:bg-[#3a0ca3]'>
