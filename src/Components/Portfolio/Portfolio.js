...
const Portfolio = () => {
    return (
        <div className='my-14'>
            <h2 className='text-white text-2xl md:text-3xl lg:text-4xl text-center text-gradient my-16'>Projects I've made</h2>
            <div className='md:flex justify-center items-center gap-2 md:gap-10 lg:gap-14 py-6 border mx-12 md:mx-14 lg:mx-32  md:px-5 lg:px-2'>
                ...
                <button className='text-white border mt-14 px-5 py-2 mr-5 md:mr-10'>Github</button>
