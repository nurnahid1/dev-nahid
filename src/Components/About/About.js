...
const About = () => {
    return (
        <div className='md:mr-20 md:ml-20 mt-16 md:mt-28'>
            ...
            <div>
                <img className='md:max-w-xs lg:max-w-sm  max-w-96 rounded-sm ' src={img} alt="" />
            </div>
            <div className='text-center md:text-start'>
                <h2 className='text-white  mt-8 text-2xl md:text-4xl lg:text-5xl font-poppins text-gradient '>Nur Alam Nahid</h2>
